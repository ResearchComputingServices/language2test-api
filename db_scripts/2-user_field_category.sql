...
VALUES (1, 'student_id', 'Student Id', 1);

INSERT INTO public."user_field_category"(id, name, display, user_field_type_id)
VALUES (2, 'first_language', 'What is your first language?', 10);

INSERT INTO public."user_field_category"(id, name, display, user_field_type_id)
VALUES (3, 'email', 'Email', 1);

INSERT INTO public."user_field_category"(id, name, display, user_field_type_id)
VALUES (4, 'phone', 'Phone', 1);

INSERT INTO public."user_field_category"(id, name, display, user_field_type_id)
VALUES (5, 'address', 'Address', 1);

INSERT INTO public."user_field_category"(id, name, display, user_field_type_id)
VALUES (6, 'education', 'What is the highest level of education you have completed IN ANY LANGUAGE?', 12);

INSERT INTO public."user_field_category"(id, name, display, user_field_type_id)
VALUES (7, 'age', 'Please select your age', 13);

INSERT INTO public."user_field_category"(id, name, display, user_field_type_id)
VALUES (8, 'sex', 'Please indicate your sex from the choices', 14);
